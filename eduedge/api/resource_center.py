...
RESOURCE_CONFIG: dict[str, dict[str, Any]] = {
	...
	"assessment_plans": {
		...
		"singular_title": _("Assessment Plan"),
		"eyebrow": _("Assessments and Results"),
		"subtitle": _("Plan examinations and other assessments inside the permitted branch, class, subject, and academic period."),
		"icon": "calendar",
		"route": "/app/eduedge-assessment-plans",
		"full_form_route": "/app/assessment-plan",
		"create_route": "/app/assessment-plan/new-assessment-plan",
		"create_label": _("New Assessment Plan"),
		"quick_create": False,
		"quick_edit": False,
		"title_field": "assessment_name",
		"branch_field": BRANCH_FIELD,
		"search_fields": ["name", "assessment_name", "student_group", "course", "assessment_group", "examiner_name"],
		"columns": [
			{"fieldname": "assessment_name", "label": _("Assessment")},
			{"fieldname": "student_group", "label": _("Class / Student Group")},
			{"fieldname": "course", "label": _("Subject / Course")},
			{"fieldname": "assessment_group", "label": _("Assessment Group")},
			{"fieldname": "schedule_date", "label": _("Date")},
			{"fieldname": "docstatus", "label": _("Status"), "type": "DocStatus"},
		],
		"filters": [
			{"fieldname": "branch", "label": _("Branch / Campus"), "type": "Branch"},
			{"fieldname": "academic_year", "label": _("Academic Year"), "type": "Link", "options_doctype": "Academic Year"},
			{"fieldname": "academic_term", "label": _("Academic Term"), "type": "Link", "options_doctype": "Academic Term"},
			{"fieldname": "student_group", "label": _("Class / Student Group"), "type": "Link", "options_doctype": "Student Group"},
			{"fieldname": "course", "label": _("Subject / Course"), "type": "Link", "options_doctype": "Course"},
		],
		"editor_fields": [],
		"advanced_note": _("Assessment criteria, room, supervisor, timing, grading scale, and submission remain governed by the full Assessment Plan form."),
	},
	"assessment_results": {
		"doctype": "Assessment Result",
		"title": _("Assessment Results"),
		"singular_title": _("Assessment Result"),
		"eyebrow": _("Assessments and Results"),
		"subtitle": _("Review draft and submitted student results without leaving the EduEdge operational shell."),
		"icon": "list",
		"route": "/app/eduedge-assessment-results",
		"full_form_route": "/app/assessment-result",
		"create_route": "/app/eduedge-marks-entry",
		"create_label": _("Enter Marks"),
		"quick_create": False,
		"quick_edit": False,
		"title_field": "student_name",
		"branch_field": BRANCH_FIELD,
		"search_fields": ["name", "student", "student_name", "assessment_plan", "course", "student_group"],
		"columns": [
			{"fieldname": "student_name", "label": _("Student")},
			{"fieldname": "course", "label": _("Subject / Course")},
			{"fieldname": "student_group", "label": _("Class / Student Group")},
			{"fieldname": "assessment_plan", "label": _("Assessment Plan")},
			{"fieldname": "total_score", "label": _("Score")},
			{"fieldname": "grade", "label": _("Grade")},
			{"fieldname": "docstatus", "label": _("Status"), "type": "DocStatus"},
		],
		"filters": [
			{"fieldname": "branch", "label": _("Branch / Campus"), "type": "Branch"},
		...
		"editor_fields": [],
		"advanced_note": _("Marks should be entered from the EduEdge Marks Entry workbench. Submitted result records are never mutated by this list page."),
	},
	"result_profiles": {
		"doctype": "EduEdge Result Profile",
		"title": _("Result Profiles"),
		"singular_title": _("Result Profile"),
		"eyebrow": _("Result Governance"),
		"subtitle": _("Configure grading, report components, annual aggregation, statistics, and report-card presentation."),
		"icon": "settings",
		"route": "/app/eduedge-result-profiles",
		"full_form_route": "/app/eduedge-result-profile",
		"create_route": "/app/eduedge-result-profile/new-eduedge-result-profile",
		"create_label": _("New Result Profile"),
		"quick_create": False,
		"quick_edit": False,
		...
		"columns": [
			...
			{"fieldname": "institution", "label": _("Institution")},
			{"fieldname": "school_branch", "label": _("Branch / Campus")},
			{"fieldname": "grading_scale", "label": _("Grading Scale")},
			{"fieldname": "is_default", "label": _("Default"), "type": "Check"},
			{"fieldname": "is_active", "label": _("Active"), "type": "Check"},
		],
		"filters": [
			{"fieldname": "branch", "label": _("Branch / Campus"), "type": "Branch"},
		...
		"editor_fields": [],
		"advanced_note": _("Complex component mappings and metric rules open in the governed Result Profile form."),
	},
	"result_audit": {
		"doctype": "EduEdge Result Publication Log",
		"title": _("Results Audit"),
		"singular_title": _("Audit Entry"),
		"eyebrow": _("Result Governance"),
		"subtitle": _("Review immutable publication workflow history and the user responsible for each transition."),
		"icon": "shield",
		"route": "/app/eduedge-results-audit",
		"full_form_route": "/app/eduedge-result-publication-log",
		"quick_create": False,
		"quick_edit": False,
		"read_only": True,
		"title_field": "action",
		"search_fields": ["name", "result_publication", "action", "from_status", "to_status", "acted_by", "remarks"],
		"columns": [
			{"fieldname": "result_publication", "label": _("Publication")},
			{"fieldname": "action", "label": _("Action")},
			{"fieldname": "from_status", "label": _("From")},
			{"fieldname": "to_status", "label": _("To")},
			{"fieldname": "acted_by", "label": _("User")},
			{"fieldname": "acted_on", "label": _("When")},
		],
		"filters": [
			{"fieldname": "result_publication", "label": _("Publication"), "type": "Link", "options_doctype": "EduEdge Result Publication"},
			{"fieldname": "action", "label": _("Action"), "type": "Data"},
			{"fieldname": "to_status", "label": _("To Status"), "type": "Data"},
			{"fieldname": "acted_by", "label": _("User"), "type": "Link", "options_doctype": "User"},
		],
		"editor_fields": [],
		"advanced_note": _("Audit entries are read-only and are written only by governed result publication transitions."),
	}
}
