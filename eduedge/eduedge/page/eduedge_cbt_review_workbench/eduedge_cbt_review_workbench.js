frappe.pages["eduedge-cbt-review-workbench"].on_page_load = function (wrapper) {
...
frappe.pages["eduedge-cbt-review-workbench"].on_page_show = function (wrapper) {
	...
	frappe.require("edgesuite_ui.bundle.js", () => {
		...
		frappe.require("eduedge_cbt_attempt_review.bundle.js", () => {
			...
			try {
				wrapper.vue_app = window.createEduEdgeCBTAttemptReviewApp({ pageName: "eduedge-cbt-review-workbench" });
