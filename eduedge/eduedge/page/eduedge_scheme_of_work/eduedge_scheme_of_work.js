frappe.pages["eduedge-scheme-of-work"].on_page_load = function (wrapper) {
	wrapper.page = frappe.ui.make_app_page({ parent: wrapper, title: __("Scheme of Work"), single_column: true });
};

frappe.pages["eduedge-scheme-of-work"].on_page_show = function (wrapper) {
	...
	frappe.require("edgesuite_ui.bundle.js", () => {
		...
		frappe.require("eduedge_scheme_of_work.bundle.js", () => {
			...
			try {
				wrapper.vue_app = window.createEduEdgeSchemeOfWorkApp({ pageName: "eduedge-scheme-of-work" });
