...
function install(component = window.EduEdgeAcademicOperations) {
...
install(window.EduEdgeAcademicOperations);
window.installEduEdgeAcademicOperationsScheduleAction = install;
