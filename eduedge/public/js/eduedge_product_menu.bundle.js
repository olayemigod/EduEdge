		...
		sections: [
			...
			},
			{
				...
				items: [
					...
					item("Assessment Plans", "Create and manage governed assessment plans", "calendar", "/app/assessment-plan", { keywords: ["assessment", "plan", "exam", "schedule"] }),
					item("Marks Entry", "Enter marks from submitted assessment plans", "edit", "/app/assessment-result-tool", { keywords: ["marks", "scores", "assessment", "result"], quick_action: true }),
					item("Assessment Results", "Review draft and submitted assessment result records", "list", "/app/assessment-result", { keywords: ["assessment", "results", "scores", "marks"] }),
					item("Result Profiles", "Configure grading, components, annual aggregation, and report presentation", "settings", "/app/eduedge-result-profile", { keywords: ["result", "profile", "grading", "components", "annual"] }),
					...
					item("Result Analytics", "Analyse assessment results using governed report access", "chart", "/app/assessment-result/view/report", { keywords: ["result", "analytics", "report", "performance"] }),
					item("Results Audit", "Review governed result publication and approval history", "shield", "/app/eduedge-result-publication-log", { keywords: ["result", "audit", "publication", "approval", "history"] }),
				],
			},
			{
				key: "cbt-delivery",
