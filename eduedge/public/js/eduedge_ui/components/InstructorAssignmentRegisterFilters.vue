	...
	<section class="eduedge-assignment-register-filters" data-eduedge-assignment-register-filters>
		...
		<section class="eduedge-register-filter-section">
			<div class="eduedge-register-section-heading">
				...
				<small>Common operational views</small>
			</div>
		...
		<section class="eduedge-register-filter-section">
			<div class="eduedge-register-section-heading">
				<span>Lifecycle</span>
				<small>Click a status to filter immediately</small>
			</div>
		...
		<section class="eduedge-register-filter-section eduedge-register-search-section">
			...
			<button type="button" class="edge-button edge-button--primary" :disabled="busy" @click="applyFilters">
...
export default {
	...
	data() {
		const initial = this.controller.registerFilters || {};
		return {
			draft: { ...initial },
			advancedOpen: hasAdvancedFilters(initial),
		};
	},
	computed: {
