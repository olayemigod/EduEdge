...
export function buildEduEdgeMenuItems() {
	...
	return withFavorites([
		...
		menuGroup("students-admissions", __("Students & Admissions"), "user", [
			...
			menuItem(__("Student Progression"), "/app/eduedge-student-progression", "assignment", __("Promote, progress, repeat, transfer, complete, or graduate Students with governed next-session Enrollment")),
		...
		menuGroup("assessment-results", __("Assessments & Results"), "clipboard", [
			...
			menuItem(__("Assessment Plans"), "/app/eduedge-assessment-plans", "calendar", __("Create and manage governed assessment plans")),
			menuItem(__("Marks Entry"), "/app/eduedge-marks-entry", "edit", __("Enter marks from submitted assessment plans")),
			menuItem(__("Assessment Results"), "/app/eduedge-assessment-results", "list", __("Review draft and submitted assessment result records")),
			menuItem(__("Result Profiles"), "/app/eduedge-result-profiles", "settings", __("Configure grading, components, annual aggregation, and report presentation")),
			...
			menuItem(__("Result Analytics"), "/app/eduedge-result-analytics", "chart", __("Analyse assessment results using governed report access")),
			menuItem(__("Results Audit"), "/app/eduedge-results-audit", "shield", __("Review governed result publication and approval history")),
		]),
...
export const EDUEDGE_UI_ROUTES = Object.freeze([
	...
	"/app/eduedge-assessment-plans", "/app/eduedge-marks-entry", "/app/eduedge-assessment-results",
	"/app/eduedge-result-profiles", "/app/eduedge-result-analytics", "/app/eduedge-results-audit",
