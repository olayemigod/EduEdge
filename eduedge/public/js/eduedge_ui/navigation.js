...
export function buildEduEdgeMenuItems() {
	...
	return withFavorites([
		...
		menuGroup("academic-setup", __("Academic Setup"), "book", [
			...
			menuItem(__("Scheme of Work"), "/app/eduedge-scheme-of-work", "book", __("Plan, approve, version, and snapshot term curriculum delivery")),
...
export const EDUEDGE_UI_ROUTES = Object.freeze([
	...
	"/app/eduedge-scheme-of-work", "/app/eduedge-program-offerings", "/app/eduedge-academic-foundation", "/app/eduedge-academic-sessions",
