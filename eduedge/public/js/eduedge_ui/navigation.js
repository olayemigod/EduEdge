...
export function buildEduEdgeMenuItems() {
	...
	return withFavorites([
		...
		menuGroup("academic-setup", __("Academic Setup"), "book", [
			...
			menuItem(`${courses} & ${topics}`, "/app/eduedge-curriculum", "book", __(`Manage curriculum content and assigned-teacher ${topics.toLowerCase()}`)),
...
export const EDUEDGE_UI_ROUTES = Object.freeze([
	...
	"/app/eduedge-program-offerings", "/app/eduedge-academic-foundation", "/app/eduedge-academic-sessions",
