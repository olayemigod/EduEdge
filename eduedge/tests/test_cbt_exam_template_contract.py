...
class TestCBTExamTemplateContract(unittest.TestCase):
	...
	def test_controller_enforces_approved_questions_scope_and_immutability(self):
		...
		for marker in (
			...
			"Only an EduEdge platform administrator can manage public examination templates",
	...
	def test_read_api_is_branch_safe_and_public_scope_is_role_gated(self):
	...
	def test_cbt_page_uses_standalone_edgesuite_ui_runtime(self):
